...
import GooglePlayButton from "../../assets/globalAssets/GooglePlayButton.png";
import AppStoreButton from "../../assets/globalAssets/AppStoreButton.png";
import Qr_code from "../../assets/globalAssets/Qr_Code.png";
import { Link } from "react-router"; // Ensure this is from 'react-router-dom'

const Footer = () => {
  return (
    <div className="bg-Button text-Text font-poppins pt-[80px] px-4">
      {" "}
      {/* Added px-4 for horizontal padding on all screens, pt is fine */}
      <div className="container mx-auto flex flex-col">
        ...
        >
          ...
          <div className="w-full">
            {" "}
            {/* Ensure it takes full width on its grid column */}
            ...
            <div className="relative flex items-center border-[1.5px] border-Text w-full max-w-[250px] md:max-w-none">
              {" "}
              {/* Added w-full and max-w */}
              <input
                type="text"
              ...
              />
              <span className="text-[24px] pr-[15px] absolute right-0 cursor-pointer">
                {" "}
                {/* Added absolute right-0 */}
                <VscSend />
              </span>
            </div>
          </div>
          ...
          <div className="w-full">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-[10px] sm:gap-[15px]">
              {" "}
              ...
              <div>
                <img
                  ...
                  alt="QR_CODE"
                />{" "}
                {/* Used w/h for responsiveness, adjusted sizes */}
              </div>
              <div className="flex flex-col gap-[10px] w-full max-w-[150px] sm:max-w-none">
                {" "}
                {/* Added w-full and max-w for responsiveness */}
            ...
            <div className="text-[24px] mt-[24px] flex justify-center sm:justify-start items-center gap-[24px]">
              {" "}
              {/* Centered on mobile */}
              <Link
                to={""}
        ...
        {/* Copyright Section */}
        <div className="copyRight flex flex-col sm:flex-row justify-center items-center gap-y-2 sm:gap-[7px] mt-[76px] mb-[24px] text-[#828282] text-sm text-center">
          {" "}
          {/* Adjusted gap, added text-sm, text-center, flex-col for mobile */}
          <span>
            <TbCopyright />
          </span>
